...
user_db_path = "data/user_record_pj/"
...
def user_login_tracker(user_account_number, user_details):
...
user_login_tracker(3524301701, ['Tony', 'Tyree', 'team-winning@yahoo.com', 'password', 200])